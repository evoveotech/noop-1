    ...
    private var confidenceCard: some View {
        NoopCard {
            VStack(alignment: .leading, spacing: 12) {
                Text("How sure is MOVA?  ·  Solid · Building · Calibrating")
                ...
                Text("Every score carries a small honesty label. Calibrating means MOVA is still learning your baseline, or doesn't have enough data yet. Building means there's enough to show, but it's thin. Solid means full inputs are present. When MOVA can't compute a score honestly, it shows nothing rather than a fake number.")
                    .font(StrandFont.subhead)
                    .foregroundStyle(StrandPalette.textSecondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
