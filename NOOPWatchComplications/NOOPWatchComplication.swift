...
struct NOOPChargeView: View {
    ...
    private var cornerLabel: String {
        ...
        case .missing:
            return noSnapshot ? String(localized: "Open MOVA") : String(localized: "Charge")
        }
    }
    ...
    private var inlineText: String {
        if noSnapshot { return String(localized: "MOVA · open on iPhone") }
    ...
    private var accessibilityCharge: String {
        ...
        if isStale {
            ...
            return String(localized: "Charge out of date, last synced \(fresh). Open MOVA on iPhone.")
        }
        switch charge {
        ...
        case .missing:         return noSnapshot ? String(localized: "No data, open MOVA on iPhone")
                                                 : String(localized: "Charge unavailable")
        }
    }

    private var accessibilityRectangular: String {
        if noSnapshot { return String(localized: "MOVA. No data yet, open MOVA on your iPhone to sync.") }
        if isStale {
            let fresh = freshness ?? String(localized: "a while ago")
            return String(localized: "MOVA. Scores out of date, last synced \(fresh). Open MOVA on iPhone to refresh.")
        }
        ...
        return String(localized: "MOVA. \(chargePhrase), \(effortPhrase), \(restPhrase).")
    }
...
struct NOOPChargeComplication: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("MOVA Charge")
